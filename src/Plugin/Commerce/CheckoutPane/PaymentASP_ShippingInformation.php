 ...
 *   id = "payment_asp_shipping_information",
 *   label = @Translation("ASP Shipping information"),
 *   wrapper_element = "fieldset",
 * )
 */
class PaymentASP_ShippingInformation extends CheckoutPaneBase implements ContainerFactoryPluginInterface {
  ...
  public function buildPaneForm(array $pane_form, FormStateInterface $form_state, array &$complete_form) {
    ...
    $pane_form['recalculate_shipping'] = [
      '#type' => 'button',
      '#value' => $this->t('Recalculate shipping Rendroid'),
      '#recalculate' => TRUE,
      '#default_value'=> 0, // ADDED BY Rendroid
      '#ajax' => [
